...
function display() {
    ...
    if (dif1 > dif2 || dif1 > dif3){
        ...
        об'єм замовлень в ${v1} шт може змінити очікуваний дохід на ${dif1} $ `;
    }else if(dif2 > dif1 || dif2 > dif3){
        str = `висновок за результатами імітації: в залежності від випадкового попиту зпрогнозований
        об'єм замовлень в ${v2} шт може змінити очікуваний дохід на ${dif2} $ `;
    }else if(dif3 > dif2 || dif3 > dif1){
        str = `висновок за результатами імітації: в залежності від випадкового попиту зпрогнозований
        об'єм замовлень в ${v3} шт може змінити очікуваний дохід на ${dif3} $ `;
    }
